...
export function RepublishModal({ scenario, isDirty, validationResult, onPublish, onClose }: RepublishModalProps) {
  ...
  const canUpdateAndHasChanges = canUpdate && hasChanges
      ...
      >
        ...
        >
          <div className="flex items-center gap-2.5">
            <Globe size={14} style={{ color: 'oklch(82% 0.18 165)' }} />
            <span className="text-sm font-medium" style={{ color: 'var(--fg-0)' }}>Published Scenario</span>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          ...
          <div className="space-y-2">
            <p className="text-[10px] font-mono tracking-widest uppercase" style={{ color: 'var(--fg-3)' }}>Orientation</p>
          ...
          {/* Access */}
          <div className="space-y-2">
            <p className="text-[10px] font-mono tracking-widest uppercase" style={{ color: 'var(--fg-3)' }}>Access</p>
            <div className="flex gap-2">
              {([
          ...
          {/* URL slug */}
          <div className="space-y-2">
            <p className="text-[10px] font-mono tracking-widest uppercase" style={{ color: 'var(--fg-3)' }}>URL Slug</p>
            <div
            ...
            {slugError ? (
              ...
              <p className="text-[10px] font-mono" style={{ color: 'oklch(82% 0.18 165)' }}>
                {slugChanged ? '✓ Available' : '✓ Current URL'}
              </p>
            ) : slugState === 'checking' ? (
        ...
        >
          ...
          <button
            ...
            style={canUpdateAndHasChanges ? {
              ...
              cursor: !hasChanges ? 'default' : 'not-allowed',
            }}
          >
            {isUpdating ? (
